...
namespace MyWeb.MyHome.Services
{
    public class CustomCookieAuthenticationEvents : CookieAuthenticationEvents
    {
        ...
        public override async Task ValidatePrincipal(CookieValidatePrincipalContext context)
        {
            ...
            //// utc
            ////var checkClaim = userPrincipal.Claims.First(p => p.Type == "LastCheckDateTime"); // null이면 에러
            //var checkClaim = userPrincipal.Claims.Where(p => p.Type == "LastCheckDateTime").FirstOrDefault();
